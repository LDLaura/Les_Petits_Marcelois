 ...
 */
final class Version20241024171204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3BAE0AA7A76ED395 ON event');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3BAE0AA7A76ED395 ON event (user_id)');
    }
}
